        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlobName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    MimeType = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Avatar = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_FileBases_Avatar",
                        column: x => x.Avatar,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserSpeciality", x => new { x.AppUsersId, x.SpecialitiesId });
                    table.ForeignKey(
                        name: "FK_AppUserSpeciality_Specialitys_SpecialitiesId",
                        column: x => x.SpecialitiesId,
                        principalTable: "Specialitys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserSpeciality_Users_AppUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrienshipStatus = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Frienships", x => new { x.UserId, x.ToUserId });
                    table.ForeignKey(
                        name: "FK_Frienships_Users_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Frienships_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Groups_FileBases_ImageId",
                        column: x => x.ImageId,
                        principalTable: "FileBases",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Forwarded = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "FileBaseMessage",
                columns: table => new
                {
                    FileBasesId = table.Column<int>(type: "INTEGER", nullable: false),
                    MessagesId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileBaseMessage", x => new { x.FileBasesId, x.MessagesId });
                    table.ForeignKey(
                        name: "FK_FileBaseMessage_FileBases_FileBasesId",
                        column: x => x.FileBasesId,
                        principalTable: "FileBases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FileBaseMessage_Messages_MessagesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserSpeciality_SpecialitiesId",
                table: "AppUserSpeciality",
                column: "SpecialitiesId");

            migrationBuilder.CreateIndex(
                name: "IX_FileBaseMessage_MessagesId",
                table: "FileBaseMessage",
                column: "MessagesId");

            migrationBuilder.CreateIndex(
                name: "IX_Frienships_ToUserId",
                table: "Frienships",
                column: "ToUserId");
